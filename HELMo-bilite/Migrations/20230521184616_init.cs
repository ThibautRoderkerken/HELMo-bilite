    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Dispatchers", x => x.UserId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LoadingLocationId = table.Column<int>(type: "int", nullable: false),
                    UnloadingLocationId = table.Column<int>(type: "int", nullable: false),
                    DeliveryContent = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Deliveries_Addresses_LoadingLocationId",
                        column: x => x.LoadingLocationId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Deliveries_Addresses_UnloadingLocationId",
                        column: x => x.UnloadingLocationId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_LoadingLocationId",
                table: "Deliveries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_UnloadingLocationId",
                table: "Deliveries",
                column: "UnloadingLocationId");
